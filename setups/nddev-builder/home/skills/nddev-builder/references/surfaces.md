...
| --- | --- | --- | --- | --- |
| `skills` | skill | directory | <https://opencode.ai/docs/skills/, and measured by running the 1.18.25 product with `debug skill` against a temporary HOME, 2026-08-29> | **ran it** |
